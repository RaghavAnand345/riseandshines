...
<title>OutSourcing-Rise&Shine Management Consuitant (P) Ltd.</title>
<link rel="stylesheet"
...
<div id="navbar">
	...
	<div class="banner">
		<img src="aboutus.jpg">
		<div class="title">
			<a href="Rise&Shine.jsp">HOME</a><a>OutSourcing</a>
		</div>
	</div>
	<div class="maincontent">
		...
		<div class="paragraph">
			<h1>OutSourcing</h1>
			<div class = "line"></div>
			<strong>We recently have started providing Payroll and Employee record management, Compensation and Organization design<br>
			 consultancy, and deputation services. VHC has conceived this service based on the following trends:
			 </strong>
			<div class = "para">
			<span class="material-symbols-outlined">check_circle</span>
				Companies reconfiguring their manpower deployment. Focusing on activities that are core to their business<br>
				 processes supporting principal activities are being outsourced.
			</div>
			<div class = "para">
			<span class="material-symbols-outlined">check_circle</span>
				Employment of experts for projects and staff functions.
			</div>
			<div class = "para">
			<span class="material-symbols-outlined">check_circle</span>
				Enhancing per employee productivity.
			</div>
			<div class ="para"><span class="material-symbols-outlined">check_circle</span>Beating the vagaries of fluctuation in operation.</div>
		</div>
	</div>
	<div id="description">
		<div id="descripts">
